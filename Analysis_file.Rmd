...
```{R}
read_stats <- textstat_readability(dfm_grouped, measure = "TTR")

ggplot(read_stats, aes(x = Rating, y = TTR, fill = Rating)) +
  geom_boxplot(alpha = 0.7, outlier.shape = NA) +
  scale_fill_manual(values = c("#66c2a5", "#fc8d62")) +
  labs(title = "TTR Comparison Between Recommended and Not Recommended Reviews",
