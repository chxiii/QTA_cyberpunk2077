...
# time data for recommended rate visualisation
key_time <- data.frame(
  x = as.Date(c("2020-12-01", "2021-11-01", "2022-09-01", "2023-09-01")),
  y = rep(max(df_en$monthly_rating) * 0.95, 4), 
  label = c("Patch 1.0", "Patch 1.3", "Patch 1.6", "Patch 2.0")
)
...
Next, before we describe the word frequencies, we can see the rating change by time.
